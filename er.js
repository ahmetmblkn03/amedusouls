const erData = [
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "item", description: "Obtain early notable weapons: Backhand Blade (east of Scorched Ruins), Great Katana (north of abandoned Ailing Village), and Milady (Castle Ensis watchtower).", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "item", description: "Obtain the Dragon-Hunter's Great Katana by defeating the Ancient Dragon-Man in the Dragon's Pit (highly useful for Jagged Peak).", checked: false },
            { type: "item", description: "Acquire the Velvet Sword of St. Trina in the fissure and the Flowerstone Gavel from the Dragon Communion Priestess quest.", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "item", description: "Transpose Messmer's Remembrance to obtain the Spear of the Impaler or Messmer's Orb.", checked: false },
