const ds3Data = [
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Free Greirat of the Undead Settlement from his cell using the Cell Key found below the second bonfire. He sells useful items from Firelink.", missable: true, checked: false },
            ...
            { type: "action", description: "Use the Small Lothric Banner at the edge of the cliff to be transported to the Undead Settlement.", checked: false }
        ]
    },
    {
