const ds3Data = [
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to the Fire Keeper, Hawkwood the Deserter, and Blacksmith Andre.", location: "Firelink Shrine", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Free Greirat of the Undead Settlement from his cell (requires Cell Key found below the second bonfire).", location: "High Wall of Lothric", checked: false },
            { type: "npc", description: "Speak to Emma, High Priestess of Lothric Castle, to receive the Small Lothric Banner and the Way of Blue covenant item.", location: "High Wall of Lothric", checked: false },
    ...
    },
    {
        ...
        tasks: [
            { type: "npc", description: "Recruit Yoel of Londor on the broken bridge. Accept his offer to 'draw out true strength' 5 times to start the Lord of Hollows ending quest. Do this BEFORE defeating Abyss Watchers.", location: "Undead Settlement", checked: false },
            ...
            { type: "npc", description: "Speak to Cornyx of the Great Swamp in a cage at the top of the building with the pyromancers. He sells pyromancies.", location: "Undead Settlement", checked: false },
            { type: "npc", description: "Speak to Siegward of Catarina on the elevator. Help him defeat the Fire Demon.", location: "Undead Settlement", checked: false },
            { type: "npc", description: "Speak to Irina of Carim in her cell. Requires the Grave Key from the Shrine Handmaid (after giving her Mortician's Ashes). Do NOT buy dark miracles from her to keep her sane.", location: "Undead Settlement", checked: false },
    ...
    },
    {
        ...
        tasks: [
            { type: "npc", description: "Speak to Anri of Astora and Horace the Hushed at the Halfway Fortress bonfire. Receive the Blue Sentinels covenant from Horace.", location: "Road of Sacrifices", checked: false },
            { type: "item", description: "Collect the Braille Divine Tome of Carim and give it to Irina.", checked: false },
            { type: "npc", description: "Find Orbeck of Vinheim in the ruins before the Crystal Sage. Requires 10 Intelligence to recruit. You must give him a scroll before defeating 4 bosses, or he leaves permanently.", location: "Road of Sacrifices", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "If you drew out true strength 5 times, Yuria of Londor appears in Firelink. Ensure you follow her questline for the Usurpation of Fire ending.", location: "Firelink Shrine", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Get tricked by Unbreakable Patches (disguised as Siegward). Find the real Siegward in the well outside the Cleansing Chapel and throw him his armor.", location: "Cathedral of the Deep", checked: false },
    ...
    },
    {
        ...
        tasks: [
            { type: "npc", description: "Speak to Anri of Astora twice in the Catacombs. First time before the skeleton ball, second time near the wooden bridge.", location: "Catacombs of Carthus", checked: false },
            { type: "item", description: "Cut the wooden bridge to access Smouldering Lake.", checked: false },
            { type: "npc", description: "Find Horace in the Smouldering Lake cave. He is hollow; you must kill him so Anri is safe.", location: "Smouldering Lake", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Help Sirris of the Sunless Realms defeat Creighton on the bridge (use her summon sign).", location: "Irithyll of the Boreal Valley", checked: false },
            { type: "npc", description: "Speak to Anri at the Church of Yorshka bonfire. Do NOT kill the pilgrim in the corner if you want the Usurpation of Fire ending.", location: "Irithyll of the Boreal Valley", checked: false },
    ...
    },
    {
        ...
        tasks: [
            { type: "npc", description: "Find Karla in Irithyll Dungeon. You need the Jailer's Key Ring from the Profaned Capital to free her. She accepts the dark tomes.", location: "Irithyll Dungeon", checked: false },
            { type: "npc", description: "Free Siegward from his cell using the Old Cell Key.", location: "Irithyll Dungeon", checked: false },
    ...
    },
    {
        area: "Anor Londo",
        tasks: [
            { type: "npc", description: "Complete the 'marriage' ceremony with Anri in the Darkmoon Tomb (requires following Yuria's quest).", location: "Anor Londo", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "item", description: "Obtain Sorcery: Snap Freeze (located near the depths of the painting).", checked: false },
            { type: "item", description: "Obtain Pyromancy: Floating Chaos (dropped by invader Livid Pyromancer Dunnel).", checked: false },
            { type: "item", description: "Obtain Miracle: Way of White Corona (found in the Corvian Settlement).", checked: false }
        ]
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Complete Lapp's questline to get his armor.", location: "The Ringed City", checked: false },
            ...
            { type: "item", description: "Obtain Sorceries: Great Soul Dregs (Dreg Heap illusionary wall) and Old Moonlight (transpose Midir's soul).", checked: false },
            { type: "item", description: "Obtain Pyromancies: Flame Fan (dropped by Zoey) and Seething Chaos (transpose Demon Prince's soul).", checked: false },
            { type: "item", description: "Obtain Miracles: Projected Heal (Dreg Heap) and Lightning Arrow (Ringed City hidden path).", checked: false },
            { type: "item", description: "Collect all +3 Rings (e.g., Ring of Favor +3, Chloranthy Ring +3) scattered throughout the Dreg Heap and Ringed City.", checked: false }
        ]
    },
    {
