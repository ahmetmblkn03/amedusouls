const ds1Data = [
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Oscar of Astora (dying knight) to receive the Estus Flask and Undead Asylum F2 East Key.", location: "Northern Undead Asylum", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to the Crestfallen Warrior, Petrus of Thorolund (join Way of White covenant), and Anastacia of Astora.", location: "Firelink Shrine", checked: false },
            ...
            { type: "npc", description: "Speak to Solaire of Astora to receive the White Sign Soapstone.", location: "Undead Burg", checked: false },
            { type: "npc", description: "Shoot the Hellkite Wyvern's tail from beneath the bridge to obtain the Drake Sword.", location: "Undead Burg Bridge", checked: false }
        ]
    },
    {
        area: "Undead Parish & The First Bell",
        tasks: [
            { type: "npc", description: "Meet Blacksmith Andre in the Undead Parish.", location: "Undead Parish", checked: false },
            ...
            { type: "npc", description: "Rescue Knight Lautrec of Carim from his cell (requires Mystery Key).", location: "Undead Parish", checked: false },
    ...
    },
    {
        ...
        tasks: [
            { type: "npc", description: "Rescue Griggs of Vinheim from the locked room in Lower Undead Burg (requires Residence Key).", location: "Lower Undead Burg", checked: false },
            ...
            { type: "npc", description: "Rescue Laurentius of the Great Swamp from the barrel in the Depths.", location: "The Depths", checked: false },
            { type: "npc", description: "Defeat Knight Kirk (NPC Invader) in the Depths while human.", location: "The Depths", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Defeat Maneater Mildred (NPC Invader) in the swamp while human.", location: "Blighttown Swamp", checked: false },
            ...
            { type: "npc", description: "Speak to Quelana of Izalith in the swamp (requires Pyromancy Flame +10).", location: "Blighttown Swamp", checked: false }
        ]
    },
    {
        area: "Sen's Fortress",
        tasks: [
            ...
            { type: "npc", description: "Rescue Big Hat Logan from his cage using the Cage Key or Master Key.", location: "Sen's Fortress", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Solaire of Astora at the bonfire inside the castle.", location: "Anor Londo", checked: false },
            { type: "npc", description: "Invade Knight Lautrec using the Black Eye Orb (if he killed Anastacia) to retrieve her soul and the Ring of Favor and Protection.", location: "Anor Londo", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Rescue Dusk of Oolacile from the Golden Golem behind the Hydra. Summon her sign by the lake.", location: "Darkroot Basin", checked: false }
        ]
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Ingward on the roof to receive the Key to the Seal.", location: "New Londo Ruins", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Rescue Big Hat Logan from his massive cell.", location: "The Duke's Archives", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Save Solaire of Astora by opening the Lost Izalith shortcut (requires Chaos Servant +2) and killing the Sunlight Maggot.", location: "Lost Izalith", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Vamos the Blacksmith.", location: "The Catacombs", checked: false },
            ...
            { type: "npc", description: "Get kicked into a pit by Trusty Patches. Forgive him so he moves to Firelink Shrine.", location: "Tomb of the Giants", checked: false },
            { type: "npc", description: "Rescue Rhea of Thorolund from her hollowed companions.", location: "Tomb of the Giants", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "item", description: "Obtain DLC Sorceries: Dark Orb, Dark Fog, and Dark Bead in Oolacile Township and Chasm of the Abyss.", checked: false },
            { type: "item", description: "Obtain Pyromancy: Black Flame in the Chasm of the Abyss.", checked: false },
            { type: "item", description: "Obtain Sorcery: Pursuers by trading the Soul of Manus with Snuggly the Crow.", checked: false }
        ]
    },
    {
