const ds2Data = [
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Exhaust Emerald Herald's dialogue to receive the Estus Flask and unlock leveling up.", location: "Majula", checked: false },
            { type: "npc", description: "Speak to Saulden sitting by the monument to join the Way of Blue covenant (Trophy: Covenant of the Meek).", location: "Majula", checked: false },
            { type: "npc", description: "Speak to Sweet Shalquoir (the cat), Blacksmith Lenigrast, and Maughlin the Armourer. Buy the Lenigrast Key later to unlock the blacksmith.", location: "Majula", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Meet Merchant Hag Melentia at the Cardinal Tower. Buy the Lenigrast's Key and Pharros' Lockstone. Exhaust her dialogue so she moves to Majula.", location: "Cardinal Tower", checked: false },
            { type: "npc", description: "Talk to Cale the Cartographer in the cave with the rolling boulder to receive the House Key for the mansion in Majula.", location: "Forest of Fallen Giants", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Licia of Lindeldt after defeating the Dragonrider. Exhaust dialogue to move her to Majula so she can open the path to Huntsman's Copse.", location: "Heide's Tower of Flame", checked: false },
    ...
    },
    {
        area: "No-Man's Wharf",
        tasks: [
            { type: "npc", description: "Speak to Lucatiel of Mirrah at the bonfire. Her questline is crucial for the Platinum and requires her to survive 3 boss fights.", location: "No-Man's Wharf", checked: false },
            { type: "item", description: "Ring the bell at the highest point to summon the ghost ship to the docks.", checked: false },
            { type: "npc", description: "Speak to Carhillion of the Fold on the docks (requires 8 Intelligence). He sells sorceries.", location: "No-Man's Wharf", checked: false },
            { type: "npc", description: "Speak to Lonesome Gavlan in the house with the darkstalkers. You can sell items to him.", location: "No-Man's Wharf", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Find Lucatiel of Mirrah in the tower straight ahead from the Antiquated Key door. Exhaust her dialogue.", location: "The Lost Bastille", checked: false },
            { type: "npc", description: "Speak to Steady Hand McDuff. Light the torch in his room to get him to move off the chest, granting access to his services and an Estus Flask Shard.", location: "The Lost Bastille", checked: false },
    ...
    },
    {
        ...
        tasks: [
            { type: "npc", description: "Pay Licia 2,000 souls in Majula to shift the path to Huntsman's Copse.", location: "Majula", checked: false },
            { type: "npc", description: "Speak to Felkin the Outcast sitting in the chair at the start of the area (requires 8 INT and 8 FTH). He sells hexes.", location: "Huntsman's Copse", checked: false },
    ...
    },
    {
        ...
        tasks: [
            { type: "npc", description: "Speak to Stone Trader Chloanne at the start of Harvest Valley. Exhaust her dialogue so she moves to Majula.", location: "Harvest Valley", checked: false },
            ...
            { type: "npc", description: "Speak to Laddersmith Gilligan on the ledge outside the Central Earthen Peak bonfire. Buy his ladders and exhaust his dialogue.", location: "Earthen Peak", checked: false },
    ...
    },
    {
        ...
        tasks: [
            { type: "npc", description: "Speak to Magerold of Lanafir near the entrance. He offers the Dragon Remnants covenant.", location: "Iron Keep", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to the Head of Vengarl in the misty woods area to learn his gesture and buy items.", location: "Shaded Woods", checked: false },
            { type: "npc", description: "Speak to Creighton the Wanderer at the Ruined Fork Road bonfire.", location: "Ruined Fork Road", checked: false },
            { type: "npc", description: "Speak to Manscorpion Tark using the Ring of Whispers (bought from Shalquoir).", location: "Shaded Woods", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Pardon your sins with Cromwell the Pardoner after the Prowling Magus fight if needed.", location: "Brightstone Cove Tseldora", checked: false },
            { type: "boss", description: "Defeat Prowling Magus and Congregation. A very easy mob boss.", checked: false },
            { type: "npc", description: "Complete Pate and Creighton's questline. Find them fighting in Tseldora. Assist one of them to get the Tseldora Den Key.", location: "Brightstone Cove Tseldora", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Find Lucatiel of Mirrah in Black Gulch by dropping down a hidden ledge near the first giant worm. Exhaust dialogue.", location: "Black Gulch", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Chancellor Wellager at the entrance. In NG++, he sells the final miracles/pyromancies needed for Platinum.", location: "Drangleic Castle", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Grave Warden Agdayne in the Undead Crypt. Do NOT bring a torch near him or his guards will aggro.", location: "Undead Crypt", checked: false },
    ...
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Navlaan while HOLLOW to start his assassination quests. Do not release him by pulling the lever, or he will invade you constantly.", location: "Aldia's Keep", checked: false },
            { type: "boss", description: "Defeat the Guardian Dragon.", checked: false },
            { type: "npc", description: "Speak to the Ancient Dragon at the top of the Dragon Shrine to receive the Ashen Mist Heart. (Trophy: Ancient Dragon). You do not need to fight him.", location: "Dragon Shrine", checked: false },
        ]
    },
    {
        ...
        tasks: [
            ...
            { type: "npc", description: "Speak to Captain Drummond and Benhart of Jugo in the memories. Ensure Benhart survives the Giant Lord fight.", location: "Memories of the Ancients", checked: false },
            { type: "boss", description: "Defeat the Giant Lord in the Memory of Jeigh. Collect the Giant's Kinship.", checked: false }
        ]
    },
    {
        area: "Crown of the Sunken King (DLC)",
        tasks: [
            { type: "boss", description: "Defeat Elana, Squalid Queen.", checked: false },
            { type: "boss", description: "Defeat Sinh, the Slumbering Dragon.", checked: false },
            { type: "item", description: "Obtain Sorcery: Focus Souls in Shulva, Sanctum City (shoot switches to drop the platform).", checked: false },
            { type: "item", description: "Obtain Miracle: Denial in Dragon's Sanctum (in the puzzle room with rotating circular doors).", checked: false },
            { type: "item", description: "Obtain Hex: Promised Walk of Peace in Shulva (on a ledge near the Tower of Prayer, shoot obelisk to access).", checked: false },
            { type: "item", description: "Obtain Hex: Dark Greatsword in Shulva, Sanctum City (drop down to a lower ledge after the first bonfire).", checked: false }
        ]
    },
    {
        area: "Crown of the Old Iron King (DLC)",
        tasks: [
            { type: "boss", description: "Defeat Fume Knight at the bottom of Brume Tower.", checked: false },
            { type: "boss", description: "Defeat Sir Alonne in the Memory of the Old Iron King.", checked: false },
            { type: "item", description: "Obtain Pyromancy: Dance of Fire in Brume Tower (on a corpse down some snowy stairs).", checked: false },
            { type: "item", description: "Obtain Pyromancy: Fire Snake in Brume Tower (requires Tower Key to access).", checked: false },
            { type: "item", description: "Obtain Hex: Recollection in Brume Tower (near the Smelter Throne bonfire).", checked: false },
            { type: "item", description: "Obtain Pyromancy: Outcry by trading the Soul of Nadalia, Bride of Ash (requires finding all 12 Smelter Wedges and defeating Fume Knight & Sir Alonne).", checked: false }
        ]
    },
    {
        area: "Crown of the Ivory King (DLC)",
        tasks: [
            { type: "boss", description: "Defeat Aava, the King's Pet in Frozen Eleum Loyce. (Requires the Eye of the Priestess to see the boss).", checked: false },
            { type: "boss", description: "Defeat the Burnt Ivory King. (Gather the 3 Loyce Knights before dropping down to the Old Chaos).", checked: false },
            { type: "item", description: "Obtain Sorcery: Soul Flash in Frozen Eleum Loyce (pull lever to operate the elevator, check paths).", checked: false },
            { type: "item", description: "Obtain Miracle: Splintering Lightning Spear in Frozen Eleum Loyce (after thawing the ice, near the second bonfire).", checked: false },
            { type: "item", description: "Obtain Hex: Dark Dance in Frozen Eleum Loyce (after thawing the ice, look for a hidden path).", checked: false }
        ]
    },
    {
